...
QUERIES = [
    "List the top 3 countries, buy descending order of number of cities they have listed in the DB."
    "Give me the age distribution of all the employees in the company."
    "Give me the range of dates between which the sales happened in the company."
    "Give me the name top sales person for each year. "
    "Give me the name of top sales person for the year 2017."
    "Give me the summary of the all the tables, range data points, number of records etc."
]